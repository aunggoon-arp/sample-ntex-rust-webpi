...
impl RoleService {
    ...
    pub async fn create_role(input: CreateRoleInput, pool: &MySqlPool) -> ApiResult<u64> {
    ...
    pub async fn update_role(input: UpdateRoleInput, pool: &MySqlPool) -> ApiResult<u64> {
